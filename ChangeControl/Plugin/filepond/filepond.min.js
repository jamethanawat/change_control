...
! function (e, t) {
    ...
    var t, n, r = function (e, t) {
        ...
        S = {
            styles: function (e) {
                ...
                return r.rect = {
                    ...
                    write: function () {
                        if (D(u, n)) return y(i.element, n), Object.assign(u, Object.assign({}, n)), !0
                    },
                    destroy: function () {}
                }
            },
                    ...
                    x = {
                        ...
                        _write: function (e, t, n) {
                            ...
                            return M.forEach(function (i) {
                                ...
                                r.element.parentNode || (k.appendChild(r.element, i), r._read(), r._write(e, R(r, t), n), o = !1)
                            }), m = o, L({
                                props: r,
                                root: k,
                                actions: t,
        ...
        Re = {
            ...
            iconDone: ['<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"><path d="M18.293 9.293a1 1 0 0 1 1.414 1.414l-7.002 7a1 1 0 0 1-1.414 0l-3.998-4a1 1 0 1 1 1.414-1.414L12 15.586l6.294-6.293z" fill="currentColor" fill-rule="nonzero"/></svg>', Te.STRING],
            iconEdit: ['<i class="fas fa-pen" style="transform: scale(0.7);"></i>', Te.STRING],
        ...
        Le = [de.LOADING, de.PROCESSING, de.PROCESSING_QUEUED, de.INIT],
        Pe = [de.PROCESSING_COMPLETE],
        be = function (e) {
            ...
            return {
                GET_STATUS: function () {
                    var t = ye(e.items),
                        ...
                        i = Se.IDLE,
                        a = Se.READY;
                    return 0 === t.length ? n : t.some(be) ? r : t.some(Me) ? o : t.some(we) ? a : i
                },
                GET_ITEM: function (t) {
                    return Oe(e.items, t)
                },
                GET_ACTIVE_ITEM: function (t) {
                    return Oe(ye(e.items), t)
                },
                ...
                GET_ITEMS_BY_STATUS: function (t) {
                    return ye(e.items).filter(function (e) {
                        return e.status === t
                    })
                },
                GET_TOTAL_ITEMS: function () {
                    return ye(e.items).length
                },
                IS_ASYNC: function () {
                    return z(e.options.server) && (z(e.options.server.process) || j(e.options.server.process))
                }
            }
        },
        Ne = function (e, t, n) {
        ...
        qe = function () {
            ...
            return e.getFullYear() + "-" + Ve(e.getMonth() + 1, "00") + "-" + Ve(e.getDate(), "00") + "_" + Ve(e.getHours(), "00") + "-" + Ve(e.getMinutes(), "00") + "-" + Ve(e.getSeconds(), "00")
        },
        Fe = function (e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null,
                o = "string" == typeof n ? e.slice(0, e.size, n) : e.slice(0, e.size, e.type);
            return o.lastModifiedDate = new Date, e._relativePath && (o._relativePath = e._relativePath), V(t) || (t = qe()), t && null === r && Be(t) ? o.name = t : (r = r || function (e) {
            ...
            var t = {
                ...
                n = function (n) {
                    e ? (t.timestamp = Date.now(), t.request = e(n, function (e) {
                        t.duration = Date.now() - t.timestamp, t.complete = !0, e instanceof Blob && (e = Fe(e, e.name || Ue(n))), r.fire("load", e instanceof Blob ? e : e ? e.body : null)
                    }, function (e) {
                        ...
                        var n = ze("string" == typeof e ? e : e.headers);
                        r.fire("meta", {
                            size: t.size || n.size,
                            filename: n.name,
                            source: n.source
                ...
                r = Object.assign({}, se(), {
                    ...
                    load: function () {
                        var e, o, i = t.source;
                        r.fire("init", i), i instanceof File ? r.fire("load", i) : i instanceof Blob ? r.fire("load", Fe(i, i.name)) : Ge(i) ? r.fire("load", Fe(ke(i), e, null, o)) : n(i)
                    }
                });
            return r
        },
        ...
        Ke = function (e) {
            return function (t) {
                e(Ze("error", 0, "Timeout", t.getAllResponseHeaders()))
            }
        },
        Je = function (e) {
            return /\?/.test(e)
        ...
        tt = function () {
            ...
            return function (o, i, a, u, s, l) {
                var c = $e(o, et(e, t.url), Object.assign({}, t, {
                    responseType: "blob"
                }));
                return c.onload = function (e) {
                    var r = e.getAllResponseHeaders(),
                        a = ze(r).name || Ue(o);
                    i(Ze("load", e.status, "HEAD" === t.method ? null : Fe(n(e.response), a), r))
                }, c.onerror = function (e) {
                    a(Ze("error", e.status, r(e.response) || e.statusText, e.getAllResponseHeaders()))
                }, c.onheaders = function (e) {
                    l(Ze("headers", e.status, null, e.getAllResponseHeaders()))
                }, c.ontimeout = Ke(a), c.onprogress = u, c.onabort = s, c
            }
        };
    ...
    "function" == typeof Symbol && Symbol.asyncIterator && (rt.prototype[Symbol.asyncIterator] = function () {
        return this
    ...
    var at = 0,
        ...
        lt = 3,
        ct = 4,
        ft = function (e, t, n, r, o, i, a, u, s, l, c) {
            ...
            var D, y, S, A, L = function (e) {
                    return e.status === at || e.status === lt
                },
                P = function (t) {
                    if (!T.aborted)
                        if (t = t || f.find(L)) {
                            ...
                            var n = p.ondata || function (e) {
                                ...
                                c = t.request = $e(n(t.data), u, Object.assign({}, p, {
                                    headers: l
                                }));
                            c.onload = function () {
                                t.status = ut, t.request = null, w()
                            }, c.onprogress = function (e, n, r) {
                                t.progress = e ? n : null, M()
                            }, c.onerror = function (e) {
                                t.status = lt, t.request = null, t.error = o(e.response) || e.statusText, b(t) || a(Ze("error", e.status, o(e.response) || e.statusText, e.getAllResponseHeaders()))
                            }, c.ontimeout = function (e) {
                                t.status = lt, t.request = null, b(t) || Ke(a)(e)
                            }, c.onabort = function () {
                                t.status = at, t.request = null, s()
                            }
                ...
                b = function (e) {
                    return 0 !== e.retries.length && (e.status = ct, clearTimeout(e.timeout), e.timeout = setTimeout(function () {
                        P(e)
                    }, e.retries.shift()), !0)
                },
                M = function () {
            ...
            return T.serverId ? (D = function (e) {
                T.aborted || (f.filter(function (t) {
                    return t.offset < e
                }).forEach(function (e) {
                    e.status = ut, e.progress = e.size
                }), w())
            }, y = et(e, p.url, T.serverId), S = {
                headers: "function" == typeof t.headers ? t.headers(T.serverId) : Object.assign({}, t.headers),
                method: "HEAD"
            }, (A = $e(null, y, S)).onload = function (e) {
                return D(I(e, S.method))
            }, A.onerror = function (e) {
                return a(Ze("error", e.status, m(e.response) || e.statusText, e.getAllResponseHeaders()))
            }, A.ontimeout = Ke(a)) : function (i) {
                var u = new FormData;
                ...
                return function (o, i, a, u, s, l, c) {
                    if (o) {
                        var f = r.chunkUploads,
                            ...
                            p = f && (d || r.chunkForce);
                        if (o instanceof Blob && p) return ft(e, t, n, o, i, a, u, s, l, c, r);
                        ...
                        var I = $e(E(v), et(e, t.url), t);
                        return I.onload = function (e) {
                            a(Ze("load", e.status, _(e.response), e.getAllResponseHeaders()))
                        }, I.onerror = function (e) {
                            u(Ze("error", e.status, T(e.response) || e.statusText, e.getAllResponseHeaders()))
                        }, I.ontimeout = Ke(u), I.onprogress = s, I.onabort = l, I
                    }
                }
            }(e, t, n, r) : null
        },
        pt = function () {
            ...
            return function (o, i, a) {
                ...
                return u.onload = function (e) {
                    i(Ze("load", e.status, n(e.response), e.getAllResponseHeaders()))
            ...
            var t = {
                ...
                r = Object.assign({}, se(), {
                    process: function (n, o) {
                        ...
                        }, Et(750, 1500)), t.request = e(n, o, function (e) {
                            t.response = z(e) ? e : {
                                type: "load",
                                code: 200,
                                body: "" + e,
                ...
                f = Object.assign({
                    ...
                    load: function (t, n, r) {
                        i.source = t, i.file ? l("load-skip") : (i.file = function (e) {
                            ...
                            return e instanceof Blob || Ge(e) ? t[0] = e.name || qe() : Ge(e) ? (t[1] = e.length, t[2] = Ye(e)) : V(e) && (t[0] = Ue(e), t[1] = 0, t[2] = "application/octet-stream"), {
                                name: t[0],
                                size: t[1],
                                type: t[2]
                            }
                            ...
                            i.activeLoader = null;
                            var n = function (t) {
                                i.file = vt(t) ? t : i.file, e === pe.LIMBO && i.serverFileReference ? s(de.PROCESSING_COMPLETE) : s(de.IDLE), l("load")
                            };
        ...
        gt = function (e, t, n, r, o, i) {
            ...
            return a.onload = function (n) {
                var r = n.getAllResponseHeaders(),
                    o = ze(r).name || Ue(e);
                t(Ze("load", n.status, Fe(n.response, o), r))
            }, a.onerror = function (e) {
                n(Ze("error", e.status, e.statusText, e.getAllResponseHeaders()))
            }, a.onheaders = function (e) {
                i(Ze("headers", e.status, null, e.getAllResponseHeaders()))
            }, a.ontimeout = Ke(n), a.onprogress = r, a.onabort = o, a
        },
        ht = function (e) {
        ...
        Rt = function (e) {
            return function () {
                return j(e) ? e.apply(void 0, arguments) : e
            }
        },
        Ot = function (e, t) {
        ...
        St = function (e, t) {
            return function () {
                var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    s = Oe(e.items, r);
                s ? t(s, i, u) : u({
                    error: Ze("error", 0, "Item not found"),
                    file: null
                })
            }
        },
        At = function (e, t, n) {
            return {
                ...
                DID_SET_FILES: function (t) {
                    ...
                    }), i = ye(n.items), o.forEach(function (t, n) {
                        i.find(function (e) {
                ...
                DID_UPDATE_ITEM_METADATA: function (r) {
                    ...
                    clearTimeout(n.itemUpdateTimeout), n.itemUpdateTimeout = setTimeout(function () {
                        ...
                        if (t("IS_ASYNC")) {
                            ...
                            return r.status === de.PROCESSING_COMPLETE ? (i = n.options.instantUpload, void r.revert(pt(n.options.server.url, n.options.server.revert), t("GET_FORCE_REVERT")).then(i ? a : function () {}).catch(function () {})) : r.status === de.PROCESSING ? function (e) {
                ...
                MOVE_ITEM: function (e) {
                    ...
                    if (o) {
                        ...
                        i !== (r = Ne(r, 0, n.items.length - 1)) && n.items.splice(r, 0, n.items.splice(i, 1)[0])
                    }
                },
                SORT: function (r) {
                    var o = r.compare;
                    yt(n, o), e("DID_SORT_ITEMS", {
                ...
                ADD_ITEMS: function (n) {
                    ...
                    var p = t("GET_IGNORED_FILES"),
                        E = r.filter(function (e) {
                            return vt(e) ? !p.includes(e.name.toLowerCase()) : !C(e)
                        }).map(function (t) {
                            return new Promise(function (n, r) {
                                e("ADD_ITEM", {
                                    interactionMethod: i,
                ...
                ADD_ITEM: function (r) {
                    var o = r.source,
                        ...
                        p = void 0 === d ? {} : d;
                    if (C(o)) f({
                        error: Ze("error", 0, "No source"),
                        file: null
                    });
                    else if (!vt(o) || !n.options.ignoredFiles.includes(o.name.toLowerCase())) {
                        if (! function (e) {
                                var t = ye(e.items).length;
                            ...
                            if (_.status === de.PROCESSING_COMPLETE || _.status === de.PROCESSING_REVERT_ERROR) {
                                ...
                                if (_.revert(pt(n.options.server.url, n.options.server.revert), T).then(function () {
                                        T && e("ADD_ITEM", {
                                            source: o,
                                            index: a,
                                            interactionMethod: u,
                        ...
                        var v = "local" === p.type ? pe.LOCAL : "limbo" === p.type ? pe.LIMBO : pe.INPUT,
                            I = It(v, v === pe.INPUT ? null : o, p.file);
                        ...
                        n.options.itemInsertLocationFreedom || (a = "before" === m ? -1 : n.items.length),
                            function (e, t, n) {
                                C(t) || (void 0 === n ? e.push(t) : function (e, t, n) {
                                    e.splice(t, 0, n)
                                }(e, n = Ne(n, 0, e.length), t))
                            }(n.items, I, a), j(m) && o && yt(n, m);
                        var g = I.id;
                        I.on("load-init", function () {
                            ...
                            var r = Rt(n.options.labelFileLoadError)(t);
                            ...
                            e("DID_THROW_ITEM_PROCESSING_ERROR", {
                                ...
                                error: t,
                                status: {
                                    main: Rt(n.options.labelFileProcessingError)(t),
                                    sub: n.options.labelTapToRetry
                                }
                            })
                            ...
                            e("DID_THROW_ITEM_PROCESSING_REVERT_ERROR", {
                                ...
                                error: t,
                                status: {
                                    main: Rt(n.options.labelFileProcessingRevertError)(t),
                                    sub: n.options.labelTapToRetry
                                }
                            })
                        ...
                        var h = n.options.server || {},
                            ...
                            D = h.restore,
                            y = h.fetch;
                        I.load(o, We(v === pe.INPUT ? V(o) && function (e) {
                            return (e.indexOf(":") > -1 || e.indexOf("//") > -1) && ht(location.href) !== ht(e)
                        }(o) ? tt(R, y) : gt : tt(R, v === pe.LIMBO ? D : O)), function (e, n, r) {
                            Ie("LOAD_FILE", e, {
                                query: t
                            }).then(n).catch(r)
                        })
                ...
                COMPLETE_LOAD_ITEM: function (r) {
                    ...
                    if (j(s) && u && yt(n, s), e("DID_LOAD_ITEM", {
                            id: o.id,
                            error: null,
                ...
                RETRY_ITEM_LOAD: St(n, function (e) {
                    e.retryLoad()
                }),
                REQUEST_ITEM_PREPARE: St(n, function (t, n, r) {
                ...
                REQUEST_ITEM_PROCESSING: St(n, function (r, o, i) {
                    if (r.status === de.IDLE || r.status === de.PROCESSING_ERROR) r.status !== de.PROCESSING_QUEUED && (r.requestProcessing(), e("DID_REQUEST_ITEM_PROCESSING", {
                        ...
                        r.status === de.PROCESSING_COMPLETE || r.status === de.PROCESSING_REVERT_ERROR ? r.revert(pt(n.options.server.url, n.options.server.revert), t("GET_FORCE_REVERT")).then(u).catch(function () {}) : r.status === de.PROCESSING && r.abortProcessing().then(u)
                    }
                }),
                PROCESS_ITEM: St(n, function (r, o, i) {
                    ...
                    if (t("GET_ITEMS_BY_STATUS", de.PROCESSING).length !== a) {
                        if (r.status !== de.PROCESSING) {
                            ...
                            var s = n.options;
                            r.process(_t(dt(s.server.url, s.server.process, s.name, {
                ...
                RETRY_ITEM_PROCESSING: St(n, function (t) {
                    e("REQUEST_ITEM_PROCESSING", {
                        query: t
                    })
                }),
                REQUEST_REMOVE_ITEM: St(n, function (n) {
                ...
                RELEASE_ITEM: St(n, function (e) {
                    e.release()
                }),
                REMOVE_ITEM: St(n, function (r, o) {
                    var i = function () {
                            var t = r.id;
                            mt(n.items, t).archive(), e("DID_REMOVE_ITEM", {
                                error: null,
                                id: t,
                                item: r
                            }), Ot(e, n), o(fe(r))
                        ...
                        a = n.options.server;
                    r.origin === pe.LOCAL && a && j(a.remove) ? (e("DID_START_ITEM_REMOVE", {
                        id: r.id
                    }), a.remove(r.source, function () {
                        return i()
                    }, function (t) {
                        e("DID_THROW_ITEM_REMOVE_ERROR", {
                            id: r.id,
                            error: Ze("error", 0, t, null),
                            status: {
                                main: Rt(n.options.labelFileRemoveError)(t),
                                sub: n.options.labelTapToRetry
                            }
                        })
                    })) : (r.origin === pe.LIMBO && null !== r.serverId && r.revert(pt(n.options.server.url, n.options.server.revert), t("GET_FORCE_REVERT")), i())
                }),
                ABORT_ITEM_LOAD: St(n, function (e) {
                    e.abortLoad()
                }),
                ABORT_ITEM_PROCESSING: St(n, function (t) {
                ...
                REQUEST_REVERT_ITEM_PROCESSING: St(n, function (r) {
                ...
                REVERT_ITEM_PROCESSING: St(n, function (r) {
                    r.revert(pt(n.options.server.url, n.options.server.revert), t("GET_FORCE_REVERT")).then(function () {
        ...
        Gt = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ".";
            return (e = Math.round(Math.abs(e))) < 1e3 ? e + " bytes" : e < Bt ? Math.floor(e / Ut) + " KB" : e < Vt ? qt(e / Bt, 1, t) + " MB" : qt(e / Vt, 2, t) + " GB"
        },
        Ut = 1e3,
        Bt = 1e6,
        Vt = 1e9,
        ...
        Ft = function (e) {
            var t = e.root,
                n = e.props;
            bt(t.ref.fileSize, Gt(t.query("GET_ITEM_SIZE", n.id))), bt(t.ref.fileName, Lt(t.query("GET_ITEM_NAME", n.id)))
        },
        xt = function (e) {
            var t = e.root,
                n = e.props;
            Y(t.query("GET_ITEM_SIZE", n.id)) || bt(t.ref.fileSize, t.query("GET_LABEL_FILE_SIZE_NOT_AVAILABLE"))
        },
        Yt = L({
            name: "file-info",
            ignoreRect: !0,
            ...
            create: function (e) {
                ...
                var o = Pt("span");
                o.className = "filepond--file-info-sub", t.appendChild(o), t.ref.fileSize = o, bt(o, t.query("GET_LABEL_FILE_WAITING_FOR_SIZE")), bt(r, Lt(t.query("GET_ITEM_NAME", n.id)))
            },
            mixins: {
        ...
        jt = function (e) {
            ...
            bt(t.ref.main, r), bt(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"))
        },
        Ht = function (e) {
            var t = e.root;
            bt(t.ref.main, ""), bt(t.ref.sub, "")
        },
        Xt = function (e) {
            var t = e.root,
                n = e.action;
            bt(t.ref.main, n.status.main), bt(t.ref.sub, n.status.sub)
        },
        zt = L({
            name: "file-status",
            ignoreRect: !0,
            ...
            write: P({
                DID_LOAD_ITEM: Ht,
                DID_REVERT_ITEM_PROCESSING: Ht,
                DID_REQUEST_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    bt(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING")), bt(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"))
                },
                DID_ABORT_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    bt(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_ABORTED")), bt(t.ref.sub, t.query("GET_LABEL_TAP_TO_RETRY"))
                },
                DID_COMPLETE_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    bt(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_COMPLETE")), bt(t.ref.sub, t.query("GET_LABEL_TAP_TO_UNDO"))
                },
                ...
                DID_UPDATE_ITEM_LOAD_PROGRESS: jt,
                DID_THROW_ITEM_LOAD_ERROR: Xt,
                DID_THROW_ITEM_INVALID: Xt,
            ...
            create: function (e) {
                ...
                var r = Pt("span");
                r.className = "filepond--file-status-sub", t.appendChild(r), t.ref.sub = r, jt({
                    root: t,
                    action: {
                        progress: null
                    }
        ...
        Wt = {
            ...
            AddDescription: {
                ...
                action: "REQUEST_REVERT_ITEM_PROCESSING",
                icon: "GET_ICON_EDIT",
                className: "filepond--file-action-button",
                align: "BUTTON_PROCESS_ITEM_POSITION"
            }
        },
        Qt = [];
    ...
    var $t, Zt = function (e) {
        ...
        on = {
            ...
            DID_START_ITEM_PROCESSING: rn,
            DID_REQUEST_ITEM_PROCESSING: rn,
            DID_UPDATE_ITEM_PROCESS_PROGRESS: rn,
        ...
        sn = L({
            create: function (e) {
                var t = e.root,
                    ...
                    s = a ? Qt.concat() : Qt.filter(function (e) {
                        return !/Process/.test(e)
                    });
                if (i && o && (Wt.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM", Wt.RevertItemProcessing.icon = "GET_ICON_REMOVE"), a && !o) {
                    s.splice(-1, 1);
                    var l = on.DID_COMPLETE_ITEM_PROCESSING;
                    l.info.translateX = Jt, l.info.translateY = Kt, l.status.translateY = Kt, l.processingCompleteIndicator = {
                        opacity: 1,
                        scaleX: 1,
                        scaleY: 1
                    }
                ...
                if (u && o) {
                    Wt.RevertItemProcessing.align = "BUTTON_REMOVE_ITEM_POSITION";
                    var c = on.DID_COMPLETE_ITEM_PROCESSING;
                    c.info.translateX = Zt, c.status.translateY = Kt, c.processingCompleteIndicator = {
                        opacity: 1,
                        scaleX: 1,
                        scaleY: 1
                    }
                ...
                }), t.ref.processingCompleteIndicator = t.appendChildView(t.createChildView(an)), t.ref.processingCompleteIndicator.element.dataset.align = t.query("GET_STYLE_BUTTON_PROCESS_ITEM_POSITION"), t.ref.info = t.appendChildView(t.createChildView(Yt, {
                    id: n
                })), t.ref.status = t.appendChildView(t.createChildView(zt, {
                    id: n
                }));
                var f = t.appendChildView(t.createChildView(Ct, {
                    opacity: 0,
                ...
                var d = t.appendChildView(t.createChildView(Ct, {
                    opacity: 0,
        ...
        ln = L({
            create: function (e) {
                var t = e.root,
                    n = e.props;
                t.ref.fileName = Pt("legend"), t.appendChild(t.ref.fileName), t.ref.file = t.appendChildView(t.createChildView(sn, {
                    id: n.id
                })), t.ref.data = !1
            },
            ignoreRect: !0,
            write: P({
                DID_LOAD_ITEM: function (e) {
                    var t = e.root,
                        n = e.props;
                    bt(t.ref.fileName, Lt(t.query("GET_ITEM_NAME", n.id)))
                }
            }),
            didCreateView: function (e) {
                me("CREATE_VIEW", Object.assign({}, e, {
        ...
        Tn = P({
            ...
            i && i.type !== r.currentState && (r.currentState = i.type, t.element.dataset.filepondItemState = En[r.currentState] || "");
            var a = t.query("GET_ITEM_PANEL_ASPECT_RATIO") || t.query("GET_PANEL_ASPECT_RATIO");
            a ? o || (t.height = t.rect.element.width * a) : (_n({
                root: t,
                actions: n,
                props: r
        ...
        vn = L({
            create: function (e) {
                ...
                }, t.element.id = "filepond--item-" + n.id, t.element.addEventListener("click", t.ref.handleClick), t.ref.container = t.appendChildView(t.createChildView(ln, {
                    id: n.id
                })), t.ref.panel = t.appendChildView(t.createChildView(dn, {
                    name: "item-panel"
        ...
        Rn = P({
            DID_ADD_ITEM: function (e) {
                ...
                t.ref.lastItemSpanwDate = u, t.appendChildView(t.createChildView(vn, {
                    spawnDate: u,
                    id: r,
                    opacity: s,
                    interactionMethod: i
        ...
        An = function (e) {
            var t = e.root,
                n = e.action;
            Sn(t.element, "accept", !!n.value, n.value ? n.value.join(",") : "")
        },
        Ln = function (e) {
            var t = e.root,
                n = e.action;
        ...
        Nn = L({
            ...
            create: function (e) {
                var t = e.root,
                    n = e.props;
                t.element.id = "filepond--browser-" + n.id, i(t.element, "name", t.query("GET_NAME")), i(t.element, "aria-controls", "filepond--assistant-" + n.id), i(t.element, "aria-labelledby", "filepond--drop-label-" + n.id), An({
                    root: t,
                    action: {
        ...
        Vn = L({
            ...
            create: function (e) {
                ...
                }, r.addEventListener("keydown", t.ref.handleKeyDown), t.element.addEventListener("click", t.ref.handleClick), Bn(r, n.caption), t.appendChild(r), t.ref.label = r
            },
            destroy: function (e) {
                var t = e.root;
        ...
        Fn = P({
            DID_DRAG: function (e) {
                ...
                t.ref.blob ? (t.ref.blob.translateX = n.position.scopeLeft, t.ref.blob.translateY = n.position.scopeTop, t.ref.blob.scaleX = 1, t.ref.blob.scaleY = 1, t.ref.blob.opacity = 1) : function (e) {
                    ...
                    t.ref.blob = t.appendChildView(t.createChildView(qn, {
                        opacity: 0,
                        scaleX: 2.5,
                        scaleY: 2.5,
                        translateX: n,
        ...
        Xn = ["jpg", "jpeg", "png", "gif", "bmp", "webp", "svg", "tiff"],
        zn = ["css", "csv", "html", "txt"],
        Wn = {
            zip: "zip|compressed",
        ...
        Qn = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
            return e = e.toLowerCase(), Xn.includes(e) ? "image/" + ("jpg" === e ? "jpeg" : "svg" === e ? "svg+xml" : e) : zn.includes(e) ? "text/" + e : Wn[e] || ""
        },
        $n = function (e) {
            return new Promise(function (t, n) {
                var r = ar(e);
                if (r.length && !Zn(e)) return t(r);
                Kn(e).then(t)
            })
        },
        Zn = function (e) {
        ...
        er = function (e) {
            return new Promise(function (t, n) {
                rr(e) ? tr(ir(e)).then(t).catch(n) : t([e.getAsFile()])
            })
        },
        tr = function (e) {
            return new Promise(function (t, n) {
        ...
        nr = function (e) {
            ...
            var t = e.lastModifiedDate,
                n = e.name;
            return (e = e.slice(0, e.size, Qn(Be(e.name)))).name = n, e.lastModifiedDate = t, e
        },
        rr = function (e) {
            return or(e) && (ir(e) || {}).isDirectory
        },
        or = function (e) {
        ...
        dr = function (e) {
            ...
            var i = {
                ...
                addListener: function (a) {
                    return t.push(a),
                        function () {
                            t.splice(t.indexOf(a), 1), 0 === t.length && (lr.splice(lr.indexOf(i), 1), r(n, function (t) {
        ...
        Tr = function (e, t) {
            return function (e) {
                e.preventDefault(), Er = e.target, t.forEach(function (t) {
                    var n = t.element,
                        r = t.onenter;
                    pr(e, n) && (t.state = "enter", r(cr(e)))
                })
            }
        },
        vr = function (e, t) {
            return function (e) {
                ...
                $n(n).then(function (r) {
                    ...
                    t.some(function (t) {
                        ...
                        if (f)
                            if (pr(e, a)) {
                                if (o = !0, null === t.state) return t.state = "enter", void u(cr(e));
                                if (t.state = "over", i && !f) return void _r(n, "none");
                                l(cr(e))
                            } else i && !o && _r(n, "none"), t.state && (t.state = null, s(cr(e)));
                        else _r(n, "none")
                    })
                })
            }
                ...
                $n(n).then(function (n) {
                    t.forEach(function (t) {
                        var r = t.filterElement,
                            ...
                            a = t.onexit,
                            u = t.allowdrop;
                        if (t.state = null, !r || pr(e, o)) return u(n) ? void i(cr(e), n) : a(cr(e))
                    })
                })
            }
        },
        mr = function (e, t) {
            return function (e) {
                Er === e.target && t.forEach(function (t) {
                    var n = t.onexit;
                    t.state = null, n(cr(e))
                })
            }
        ...
        Or = function (e) {
            $n(e.clipboardData).then(function (e) {
                e.length && Rr.forEach(function (t) {
                    return t(e)
                })
            })
        },
        Dr = function () {
            var e = function (e) {
                ...
                t = {
                    destroy: function () {
                        var t;
                        t = e, ue(Rr, Rr.indexOf(t)), 0 === Rr.length && (document.removeEventListener("paste", Or), hr = !1)
                    },
                    onload: function () {}
                };
            return function (e) {
                Rr.includes(e) || (Rr.push(e), hr || (hr = !0, document.addEventListener("paste", Or)))
            }(e), t
        },
        yr = null,
        Sr = null,
        ...
        Pr = function (e, t, n) {
            ...
            Lr(e, n + " " + t + ", " + r + " " + (1 === r ? e.query("GET_LABEL_FILE_COUNT_SINGULAR") : e.query("GET_LABEL_FILE_COUNT_PLURAL"))), clearTimeout(Sr), Sr = setTimeout(function () {
                ! function (e) {
            ...
            write: P({
                DID_LOAD_ITEM: function (e) {
                    ...
                    if (br(t)) {
                        ...
                        Ar.push(r.filename), clearTimeout(yr), yr = setTimeout(function () {
                            Pr(t, Ar.join(", "), t.query("GET_LABEL_FILE_ADDED")), Ar.length = 0
                        }, 750)
                    }
                },
                DID_REMOVE_ITEM: function (e) {
                ...
                DID_ABORT_ITEM_PROCESSING: Mr,
                DID_REVERT_ITEM_PROCESSING: Mr,
                DID_THROW_ITEM_REMOVE_ERROR: wr,
                DID_THROW_ITEM_LOAD_ERROR: wr,
                DID_THROW_ITEM_INVALID: wr,
                DID_THROW_ITEM_PROCESSING_ERROR: wr
            }),
            tag: "span",
            name: "assistant"
        }),
        ...
        Yr = function (e) {
            ...
            if (r && !e.ref.hopper) {
                ...
                }, e.ref.hopper = o, e.ref.drip = e.appendChildView(e.createChildView(xn))
        ...
        kr = function (e, t) {
            var n = e.query("GET_ALLOW_BROWSE"),
                ...
                o = n && !r;
            o && !e.ref.browser ? e.ref.browser = e.appendChildView(e.createChildView(Nn, Object.assign({}, t, {
                onload: function (t) {
                    if (Fr(e, t)) return !1;
                    e.dispatch("ADD_ITEMS", {
                        items: t,
        ...
        Hr = P({
            ...
            DID_SET_DISABLED: function (e) {
                var t = e.root,
                    n = e.props;
                Yr(t), jr(t), kr(t, n), t.query("GET_DISABLED") ? t.element.dataset.disabled = "disabled" : t.element.removeAttribute("data-disabled")
            }
        }),
        Xr = L({
            name: "root",
            ...
            create: function (e) {
                ...
                }), t.ref.label = t.appendChildView(t.createChildView(Vn, Object.assign({}, n, {
                    translateY: null,
                    caption: t.query("GET_LABEL_IDLE")
                }))), t.ref.list = t.appendChildView(t.createChildView(yn, {
                    translateY: null
                })), t.ref.panel = t.appendChildView(t.createChildView(dn, {
                    name: "panel-root"
                })), t.ref.assistant = t.appendChildView(t.createChildView(Cr, Object.assign({}, n))), t.ref.data = t.appendChildView(t.createChildView(Hn, Object.assign({}, n))), t.ref.measure = Pt("div"), t.ref.measure.style.height = "100%", t.element.appendChild(t.ref.measure), t.ref.bounds = null, t.query("GET_STYLES").filter(function (e) {
                    return !C(e.value)
                }).map(function (e) {
                    var n = e.name,
                        r = e.value;
                    t.element.dataset[n] = r
                }), t.ref.widthPrevious = null, t.ref.widthUpdated = Gr(function () {
                ...
                t.query("GET_ALLOW_REORDER") && a && !i && (t.element.addEventListener("touchmove", Ur, {
                    passive: !1
                }), t.element.addEventListener("gesturestart", Ur))
            },
            write: function (e) {
                var t = e.root,
                    n = e.props,
                ...
                if (Hr({
                    ...
                    var o = t.ref.bounds;
                    o || (o = t.ref.bounds = qr(t), t.element.removeChild(t.ref.measure), t.ref.measure = null);
                    var i = t.ref,
                        a = i.hopper,
                        u = i.label,
                        s = i.list,
                    ...
                    if (s.translateY = Math.max(0, m - s.rect.element.marginTop) - T.top, c) {
                        ...
                        if (S.push(D), S.length > 4)
                            for (var A = S.length, L = A - 10, P = 0, b = A; b >= L; b--)
                                if (S[b] === S[b - 2] && P++, P >= 2) return;
                        l.scalable = !1, l.height = y;
                        var M = y - m - (h - T.bottom) - (p ? g : 0);
                        v.visual > M ? s.overflow = M : s.overflow = null, t.height = y
            ...
            destroy: function (e) {
                var t = e.root;
                t.ref.paster && t.ref.paster.destroy(), t.ref.hopper && t.ref.hopper.destroy(), t.element.removeEventListener("touchmove", Ur), t.element.removeEventListener("gesturestart", Ur)
            },
            mixins: {
                styles: ["height"]
            }
                ...
                S = Object.assign({}, se(), {}, T, {}, function (e, t) {
                    ...
                    removeFiles: function () {
                        ...
                        return r.length ? r.map(function (e) {
                            return v(e) ? o[e] ? o[e].id : null : e
                        }).filter(function (e) {
                            return e
                        }).map(R) : Promise.all(o.map(R))
                    },
                    ...
                    replaceElement: function (e) {
                        b(p.element, e), e.parentNode.removeChild(e), t = e
                    },
        ...
        Qr = function (e) {
            ...
            var o = n.filter(function (e) {
                ...
                var r, o = i(e, n.name);
                return t[(r = n.name, Nr(r.replace(/^data-/, "")))] = o === n.name || o, t
            }, {});
        ...
        $r = function () {
            return (arguments.length <= 0 ? void 0 : arguments[0]) instanceof HTMLElement ? function (e) {
                ...
                var r = Object.assign({}, t),
                    o = Qr("FIELDSET" === e.nodeName ? e.querySelector("input[type=file]") : e, n);
            ...
            }.apply(void 0, arguments) : Wr.apply(void 0, arguments)
        },
        Zr = ["fire", "_read", "_write"],
        Kr = function (e) {
            var t = {};
            return le(e, t, Zr), t
        },
            ...
            if (!oo.includes(e)) {
                ...
                var t, n = e({
                    ...
                    utils: {
                        ...
                        isString: V,
                        isFile: vt,
                        toNaturalFileSize: Gt,
                        replaceInString: Jr,
                        getExtensionFromFilename: Be,
                        getFilenameWithoutExtension: Tt,
        ...
        ao = ($t = d() && !("[object OperaMini]" === Object.prototype.toString.call(window.operamini)) && "visibilityState" in document && "Promise" in window && "slice" in Blob.prototype && "URL" in window && "createObjectURL" in window.URL && "performance" in window, function () {
            return $t
        }),
        uo = {
            apps: []
        ...
        so = function () {};
    if (e.Status = {}, e.FileStatus = {}, e.FileOrigin = {}, e.OptionTypes = {}, e.create = so, e.destroy = so, e.parse = so, e.find = so, e.registerPlugin = so, e.getOptions = so, e.setOptions = so, ao()) {
        ! function (e, t) {
            ...
            uo.apps.forEach(function (e) {
                return e._read()
            })
        }, function (e) {
            uo.apps.forEach(function (t) {
                return t._write(e)
            })
        });
        var lo = function t() {
        ...
        "loading" !== document.readyState ? setTimeout(function () {
            return lo()
        }, 0) : document.addEventListener("DOMContentLoaded", lo);
        var co = function () {
            return r(he(), function (t, n) {
                e.OptionTypes[t] = n[1]
            })
        };
        e.Status = Object.assign({}, Se), e.FileOrigin = Object.assign({}, pe), e.FileStatus = Object.assign({}, de), e.OptionTypes = {}, co(), e.create = function () {
            var t = $r.apply(void 0, arguments);
            return t.on("destroy", e.destroy), uo.apps.push(t), Kr(t)
        }, e.destroy = function (e) {
            var t = uo.apps.findIndex(function (t) {
                return t.isAttachedTo(e)
            });
            return t >= 0 && (uo.apps.splice(t, 1)[0].restoreElement(), !0)
        }, e.parse = function (t) {
            return Array.from(t.querySelectorAll(".filepond")).filter(function (e) {
                return !uo.apps.find(function (t) {
                    return t.isAttachedTo(e)
                })
            }).map(function (t) {
                return e.create(t)
            ...
            return z(t) && (uo.apps.forEach(function (e) {
                e.setOptions(t)
            }), function (e) {
                r(e, function (e, t) {
    ...
    e.supported = ao, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});